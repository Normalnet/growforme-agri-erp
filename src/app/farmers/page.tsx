...
export default function FarmersModule() {
  ...
  return (
    <DashboardLayout>
      ...
      {/* Dynamic Registration Modal with Cascading Selectors */}
      {showModal && (
        <div className="fixed inset-0 z-50 bg-slate-950/80 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-[#1E293B] border border-slate-700 rounded-2xl w-full max-w-xl p-6 space-y-4 shadow-2xl max-h-[90vh] overflow-y-auto">
            <div className="flex justify-between items-center border-b border-slate-800 pb-3">
              <div>
                <h3 className="font-extrabold text-white text-lg">Register Outgrower Farmer</h3>
                <p className="text-xs text-slate-400">Complete KYC & Cascading Location Profiling</p>
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-3 gap-3 bg-slate-900/60 p-3 rounded-xl border border-slate-800">
                ...
                <div>
                  <label className="block text-xs font-bold uppercase text-slate-300 mb-1">District Selector</label>
                  <select
              ...
              <div className="grid grid-cols-3 gap-3">
                ...
                <div>
                  <label className="block text-xs font-bold uppercase text-slate-300 mb-1">Network Provider</label>
                  <select
                    value={momoNetwork}
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-xs font-bold uppercase text-slate-300 mb-1">Land Tenure Agreement</label>
                  <select
              ...
              <div className="border-t border-slate-800 pt-3">
                <h4 className="font-bold text-white text-xs uppercase mb-2">Farm Asset GPS Boundary Details</h4>
                <div className="grid grid-cols-3 gap-3">
                  <div>
                  ...
                  <div>
                    <label className="block text-xs text-slate-400 mb-1">GPS Lat</label>
                    <input
                      type="text"
                      value={gpsLat}
                  ...
                  <div>
                    <label className="block text-xs text-slate-400 mb-1">GPS Lng</label>
                    <input
                      type="text"
                      value={gpsLng}

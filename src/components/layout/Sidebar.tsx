...
export function Sidebar({ collapsed, setCollapsed, mobileOpen, setMobileOpen }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed top-0 left-0 bottom-0 z-50 bg-[#0B1120] border-r border-slate-800 transition-all duration-300 flex flex-col ${
      ...
      >
        ...
        <div className="h-16 flex items-center justify-between px-4 border-b border-slate-800 bg-[#0F172A]">
          ...
          <button
            ...
            className="hidden lg:block p-1.5 rounded-lg bg-slate-800/60 text-slate-400 hover:text-white hover:bg-slate-700 transition"
          >
          ...
          <button
            onClick={() => setMobileOpen(false)}
            className="lg:hidden p-1.5 rounded-lg bg-slate-800/60 text-slate-400 hover:text-white hover:bg-slate-700 transition"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
